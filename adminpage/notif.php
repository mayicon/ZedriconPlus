...
$fetchAllNotificationsQuery = "SELECT * FROM notifications ORDER BY created_at DESC";
$result = $conn->query($fetchAllNotificationsQuery);
?>
...
<body id="body-pd">
  ...
  <path d="M2.5 4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5zM8 8a.5.5 0 0 1 .5.5V10H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V11H6a.5.5 0 0 1 0-1h1.5V8.5A.5.5 0 0 1 8 8"/>
                                    ...
                                    <a href="notif.php" class="nav_link active">
        ...
        <ul class="list-group">
            <?php while ($row = $result->fetch_assoc()): ?>
                <li class="list-group-item">
                    <?= $row['message'] ?> - <small><?= $row['created_at'] ?></small>
                </li>
            <?php endwhile; ?>
        </ul>
    </div>
